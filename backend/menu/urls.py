...
from .views import (
    ...
    NewsletterSubscriptionViewSet, JobApplicationViewSet, RecipeViewSet,
    ModifierGroupViewSet, ModifierOptionViewSet
)

router = DefaultRouter()
router.register(r'contact-messages', ContactMessageViewSet, basename='contactmessage')
router.register(r'newsletter-subscriptions', NewsletterSubscriptionViewSet, basename='newslettersubscription')
